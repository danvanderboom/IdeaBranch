...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "IdeaBranch.App.dll" comes first in this list. */
		"IdeaBranch.App.dll",
		"Azure.Core.dll",
		"Azure.Identity.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"CriticalInsight.Data.dll",
		"IdeaBranch.Domain.dll",
		"IdeaBranch.Infrastructure.dll",
		"IdeaBranch.Presentation.dll",
